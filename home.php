		...
		<tr>
			<td width="1007" bgcolor="#FFFFFF">
				...
				<p>
					...
					อาทิ WIFI อินเทอร์เน็ตความเร็วสูงทุกห้องdsss มีพัดลม และเครื่องปรับอากาศให้เลือก มีทีวี
					คอมพิวเตอร์ให้เช่า
				<p>
					เชิญชมห้องตัวอย่าง ได้ทุกวันนักขัตฤกษ์ <a href=amit.php>ติดต่อสอบถามมูมู</a>	
			</td>
			<td width="190" bgcolor="#FFFF66"><ul>
				<li><a href="home.php">หน้าแรก</li>
				<li><a href="room.php">ห้องพัก&ราคาddddddาาา</li>
 branch3
				<li><a href="facilitate.php">สิ่งอำนวยความสะดวกddddd</li>

 main
				<li><a herf="guest.php">สมุดเยี่ยม</li>
				<li><a href="contact.php">ติดต่อออออออออออออ</li>
				</ul><p>
